...
class MSResNet(nn.Module):
    def __init__(self, input_channel, layers=None, num_classes=10):
        if layers is None:
            layers = [1, 1, 1, 1]
        self.inplanes3 = 64
        self.inplanes5 = 64
        ...
        self.maxpool3 = nn.AvgPool1d(kernel_size=19, stride=1, padding=0)
        ...
        self.fc = nn.Linear(384 * 6, num_classes)
